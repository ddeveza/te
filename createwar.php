...
<div class ="container" >
	...
	<div id="projstatus"  class="col-md-4">
				...
				<select class="form-control selectpicker"  style="width: 700px">
	...
	<br>
	 ...
	 <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#AddWAR" id="AddWarBtn" 
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body" id="addnewwar">
			        <div class="form-group"  >
						<div class="form-control">
							...
							<input   type="text" name="WWeek" id="WWeek" style="width:100px" value="WW<?php echo date('W',strtotime("-1 week"))?>"></input>
			 ...
			 <div class="modal-footer">
			  ...
			  <button type="button" class="btn btn-default" id="save" data-toggle="modal"> Save Changes</button>
			 </div>
			</form>
		    </div>
	    </div>
		...
		<table class="table table-striped" id="emptable" >
			...
			?>
				<tr>
					...
					<td width="10%"><!--<button type="button" class="btn btn-success btn-xs view_data" id="<?php //echo $uniqueID ?>">view <br> </button>-->
					    <button type="button" class="btn btn-warning btn-xs edit_data" id="<?php echo $uniqueID ;?>"><i class="glyphicon glyphicon-pencil"></i> update</button>
					    <button type="button" class="btn btn-danger btn-xs delete" id="<?php echo $uniqueID ?>"><i class="glyphicon glyphicon-trash"></i>del</button></td>
				</tr>
			  <?php } }  ?>
			</tbody>
		</table>
...
<script>  //List all projects depending on Project Status
			...
			$.ajax({
				...
				success:function(data){
						...
						$("#dennis").load(location.href + " #dennis",function(){
							$("#emptable").dataTable({"order": [ 0, 'desc' ]});
